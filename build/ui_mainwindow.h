...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(403, 384);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        horizontalLayoutWidget = new QWidget(centralWidget);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(20, 10, 361, 201));
        horizontalLayout = new QHBoxLayout(horizontalLayoutWidget);
        horizontalLayout->setSpacing(6);
        horizontalLayout->setContentsMargins(11, 11, 11, 11);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        BookView = new QTableView(horizontalLayoutWidget);
        BookView->setObjectName(QStringLiteral("BookView"));
        BookView->setHorizontalScrollBarPolicy(Qt::ScrollBarAsNeeded);

        horizontalLayout->addWidget(BookView);

        DelBtn = new QPushButton(horizontalLayoutWidget);
        ...
        TitleEdit = new QLineEdit(horizontalLayoutWidget_2);
        ...
        horizontalLayoutWidget_3->setGeometry(QRect(20, 270, 361, 41));
        horizontalLayout_3 = new QHBoxLayout(horizontalLayoutWidget_3);
        horizontalLayout_3->setSpacing(6);
        horizontalLayout_3->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_3->setObjectName(QStringLiteral("horizontalLayout_3"));
        horizontalLayout_3->setContentsMargins(0, 0, 0, 0);
        IsbnEdit = new QLineEdit(horizontalLayoutWidget_3);
        IsbnEdit->setObjectName(QStringLiteral("IsbnEdit"));

        horizontalLayout_3->addWidget(IsbnEdit);
